...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management0 | oob_management | oob | MGMT | 172.100.100.108/23 | 172.100.100.1 |
...
| --------- | --------------- | ------------ | --------- |
| LeafPair3 | Vlan4094 | 192.0.0.28 | Port-Channel1000 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet3 | HOSTE_eth2 | *access | *10 | *- | *- | 3 |
| Ethernet4 | HOSTF_eth2 | *access | *30 | *- | *- | 4 |
| Ethernet5 | MLAG_PEER_DC1-LEAF5_Ethernet5 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 1000 |
| Ethernet6 | MLAG_PEER_DC1-LEAF5_Ethernet6 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 1000 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_DC1-SPINE1_Ethernet6 | routed | - | 10.0.0.61/31 | default | 9214 | False | - | - |
| Ethernet2 | P2P_LINK_TO_DC1-SPINE2_Ethernet6 | routed | - | 10.0.0.63/31 | default | 9214 | False | - | - |
...
!
interface Ethernet3
   description HOSTE_eth2
   no shutdown
   channel-group 3 mode active
!
interface Ethernet4
   description HOSTF_eth2
   no shutdown
   channel-group 4 mode active
!
interface Ethernet5
   description MLAG_PEER_DC1-LEAF5_Ethernet5
   no shutdown
   channel-group 1000 mode active
!
interface Ethernet6
   description MLAG_PEER_DC1-LEAF5_Ethernet6
   no shutdown
   channel-group 1000 mode active
```
...
| Port-Channel1000 | MLAG_PEER_DC1-LEAF5_Po1000 | switched | trunk | 2-4094 | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
interface Port-Channel1000
   description MLAG_PEER_DC1-LEAF5_Po1000
   no shutdown
   switchport
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 1.1.1.16/32 |
...
| Vlan4001 |  CORP  |  192.2.2.29/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4093 |  default  |  172.16.0.29/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4094 |  default  |  192.0.0.29/31  |  -  |  -  |  -  |  -  |  -  |
...
| ---------- | --------- | ------------------------- | -------------------- | --- | ------- | ----------------------------- | ---------------------------- | ----------------------------- | ------------- | --------------------- | ------------------ |
| 100 | 1.1.1.16 | enabled | Ethernet1 <br> Ethernet2 <br> Vlan4093 <br> | disabled | 12000 | disabled | disabled | - | - | - | - |
...
| 192.2.2.28 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | CORP | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 10 | 1.1.1.16:10010 | 10010:10010 | - | - | learned |
| 20 | 1.1.1.16:10020 | 10020:10020 | - | - | learned |
| 30 | 1.1.1.16:10030 | 10030:10030 | - | - | learned |
| 40 | 1.1.1.16:10040 | 10040:10040 | - | - | learned |
| 50 | 1.1.1.16:10050 | 10050:10050 | - | - | learned |

### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| CORP | 1.1.1.16:50001 | connected |
...
router bgp 65000
   ...
   neighbor MLAG-IPv4-UNDERLAY-PEER description DC1-LEAF5
   ...
   vrf CORP
      ...
      router-id 1.1.1.16
      neighbor 192.2.2.28 peer group MLAG-IPv4-UNDERLAY-PEER
