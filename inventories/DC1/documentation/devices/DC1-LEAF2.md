...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management0 | oob_management | oob | MGMT | 172.100.100.104/23 | 172.100.100.1 |
...
| --------- | --------------- | ------------ | --------- |
| LeafPair1 | Vlan4094 | 192.0.0.20 | Port-Channel1000 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet3 | HOSTA_eth2 | *access | *10 | *- | *- | 3 |
| Ethernet4 | HOSTB_eth2 | *access | *30 | *- | *- | 4 |
| Ethernet5 | MLAG_PEER_DC1-LEAF1_Ethernet5 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 1000 |
| Ethernet6 | MLAG_PEER_DC1-LEAF1_Ethernet6 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 1000 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_DC1-SPINE1_Ethernet2 | routed | - | 10.0.0.45/31 | default | 9214 | False | - | - |
| Ethernet2 | P2P_LINK_TO_DC1-SPINE2_Ethernet2 | routed | - | 10.0.0.47/31 | default | 9214 | False | - | - |
...
!
interface Ethernet5
   description MLAG_PEER_DC1-LEAF1_Ethernet5
   no shutdown
   channel-group 1000 mode active
!
interface Ethernet6
   description MLAG_PEER_DC1-LEAF1_Ethernet6
   no shutdown
   channel-group 1000 mode active
```
...
| Port-Channel1000 | MLAG_PEER_DC1-LEAF1_Po1000 | switched | trunk | 2-4094 | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
interface Port-Channel1000
   description MLAG_PEER_DC1-LEAF1_Po1000
   no shutdown
   switchport
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 1.1.1.12/32 |
...
| Vlan4001 |  CORP  |  192.2.2.21/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4093 |  default  |  172.16.0.21/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4094 |  default  |  192.0.0.21/31  |  -  |  -  |  -  |  -  |  -  |
...
| ---------- | --------- | ------------------------- | -------------------- | --- | ------- | ----------------------------- | ---------------------------- | ----------------------------- | ------------- | --------------------- | ------------------ |
| 100 | 1.1.1.12 | enabled | Ethernet1 <br> Ethernet2 <br> Vlan4093 <br> | disabled | 12000 | disabled | disabled | - | - | - | - |
...
| 192.2.2.20 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | CORP | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 10 | 1.1.1.12:10010 | 10010:10010 | - | - | learned |
| 20 | 1.1.1.12:10020 | 10020:10020 | - | - | learned |
| 30 | 1.1.1.12:10030 | 10030:10030 | - | - | learned |
| 40 | 1.1.1.12:10040 | 10040:10040 | - | - | learned |
| 50 | 1.1.1.12:10050 | 10050:10050 | - | - | learned |

### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| CORP | 1.1.1.12:50001 | connected |
...
router bgp 65000
   ...
   vrf CORP
      ...
      router-id 1.1.1.12
      neighbor 192.2.2.20 peer group MLAG-IPv4-UNDERLAY-PEER
